...
Παρατηρήσαμε πως υπήρχαν μερικές λανθασμένες αντιστοιχίες στα dataframe που προήλθαν από τα δεδομένα της Ευρωβουλής τα οποία διορθώσαμε.
Δεδομένου πως θέλαμε να δούμε σε ποιές ευρωομάδες εντάσσοταν οι έλληνες ευρωβουλευτές αλλά και σε ποιές όχι, κρατήσαμε τις τιμές nan για να μπορούμε να επιστρέψουμε 
σε περίπτωση που χρειαστούν στην πορεία του project.
